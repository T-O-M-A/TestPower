...
public class FenetreSimple extends Fenetre {
    ...
    public FenetreSimple(String title,
        ...
        JPanel panCas = new ImagePane(img, 0, 0);
        ...
        final JPanel panChoix = new JPanel();
        ...
        final ImagePane panObs = new ImagePane(null, 5, 15);
        ...
        switch (cas) {
            case "Un Échantillon":
                ...
                fieldNbrPiloteUn.setPreferredSize(new Dimension((int) (dim.width * 0.11 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldMeandUn.setPreferredSize(new Dimension((int) (dim.width * 0.089 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldSigmaUn.setPreferredSize(new Dimension((int) (dim.width * 0.135 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldNbrBSUn.setPreferredSize(new Dimension((int) (dim.width * 0.07 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldNbrMCUn.setPreferredSize(new Dimension((int) (dim.width * 0.053 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldTailleMCUn.setPreferredSize(new Dimension((int) (dim.width * 0.06 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldPuissanceUn.setPreferredSize(new Dimension((int) (dim.width * 0.09 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                boutonValUn.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent event) {
                        ...
                        try {
                            ...
                            img = img.getScaledInstance((int) (dim.width * 0.430),
                                    (int) (dim.height * 0.555),
                                    Image.SCALE_DEFAULT);
                        } catch (IOException ex) {
                            img = null;
                            Logger.getLogger(FenetreSimple.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        panObs.setBuffer(img);
                        panObs.repaint();
                        eng.end();
            ...
            case "Deux Échantillons Appariés":
                ...
                fieldNbrPiloteApp.setPreferredSize(new Dimension((int) (dim.width * 0.11 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldMeandApp.setPreferredSize(new Dimension((int) (dim.width * 0.058 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldSigmaUnApp.setPreferredSize(new Dimension((int) (dim.width * 0.063 * m), (int) ((dim.height - 100) * 0.045)));
                fieldSigmaDeuxApp.setPreferredSize(new Dimension((int) (dim.width * 0.063 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldCFApp.setPreferredSize(new Dimension((int) (dim.width * 0.071 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldNbrBSApp.setPreferredSize(new Dimension((int) (dim.width * 0.07 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldNbrMCApp.setPreferredSize(new Dimension((int) (dim.width * 0.053 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldTailleMCApp.setPreferredSize(new Dimension((int) (dim.width * 0.06 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldPuissanceApp.setPreferredSize(new Dimension((int) (dim.width * 0.09 * m), (int) ((dim.height - 100) * 0.045)));
            ...
            default:
                ...
                fieldNbrPiloteInd.setPreferredSize(new Dimension((int) (dim.width * 0.098 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldMeandInd.setPreferredSize(new Dimension((int) (dim.width * 0.058 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldSigmaInd.setPreferredSize(new Dimension((int) (dim.width * 0.135 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldNbrBSInd.setPreferredSize(new Dimension((int) (dim.width * 0.07 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldNbrMCInd.setPreferredSize(new Dimension((int) (dim.width * 0.053 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldTailleMCInd.setPreferredSize(new Dimension((int) (dim.width * 0.06 * m), (int) ((dim.height - 100) * 0.045)));
                ...
                fieldPuissanceInd.setPreferredSize(new Dimension((int) (dim.width * 0.09 * m), (int) ((dim.height - 100) * 0.045)));
